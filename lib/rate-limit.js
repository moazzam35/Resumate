...
export function checkRateLimit(key, limit, windowMs) {
  ...
  // Development bypass — local testing shares a single per-IP bucket (all
  // requests come from the same machine), so a handful of submissions would
  // lock the whole dev environment out for the window. Production keeps the
