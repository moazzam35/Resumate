...
export const TESTIMONIALS = [
  {
    ...
    company: "Google",
    content:
      "AI Resume Builder helped me land my dream job at Google. The AI suggestions were spot-on and the templates are gorgeous.",
  ...
  },
  {
    ...
    company: "Meta",
    content:
      "The ATS optimization feature alone is worth it. My resume went from being rejected to getting callbacks from top companies.",
  ...
  },
  {
    ...
    company: "Figma",
    content:
      "Finally, a resume builder that looks as good as the work I do. The creative template is absolutely stunning.",
  ...
  },
  {
    ...
    company: "OpenAI",
    content:
      "The cover letter generator is incredible. It saved me hours of writing and the results were professional and personalized.",
  ...
  },
  {
    ...
    company: "Stripe",
    content:
      "I've tried every resume builder out there. This is by far the best. The AI features are genuinely useful, not just gimmicky.",
  ...
  },
  {
    ...
    company: "AWS",
    content:
      "From zero to 5 interview calls in one week. The resume score feature helped me optimize every section perfectly.",
