...
export default function SupportPage() {
  ...
  return (
    ...
    >
      <div>
        <h2 className="heading-display text-2xl font-semibold text-ink">
          Help &amp; Support
        </h2>
        <p className="mt-1 text-sm text-muted">
          Have questions, problems, feedback, or need assistance with Resumate?
          Reach out directly — the developer reads every message.
        </p>
      </div>
